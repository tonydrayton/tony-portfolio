	...
	return (
		<AnimatePresence mode="wait">
			...
			<motion.header
				...
				className="fixed left-0 w-full p-2 mb-2 sm:p-4 sm:mb-0 z-10 ">
				<div
					className="m-auto flex h-full w-full max-w-sm items-center sm:max-w-xl transition-all ease-in-out duration-100">
					<div

						className="justify-center sm:justify-between m-auto p-0.5 mt-1 sm:p-2 sm:px-4 flex h-full w-fit sm:w-full max-w-full items-center rounded-full border-[1px] border-black/20 dark:border-white/20 bg-black/5 dark:bg-white/10 pl-3 pr-2 backdrop-blur-xl backdrop-filter shadow-sm">
