...
// Pre-create the box geometry and material outside the component
const createBoxGeometry = (width = 4, length = 4, cornerRadius = 1) => {
...
const preloadedGeometry = createBoxGeometry();
